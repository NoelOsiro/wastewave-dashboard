...
const recentPayments = [
  ...
  { id: 4, house: "Ochieng Compound", amount: "$50.00", method: "SasaPay", status: "Paid", date: "1 day ago" },
    ...
    <Layout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Welcome back to WasteWave. Here's what's happening today.</p>
        </div>
