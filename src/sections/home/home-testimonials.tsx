...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    content: `Clean & Complete (Design & Code). Thanks WasteWave team :)`,
    postedAt: 'April 19, 2023 23:15:30',
  },
  {
    ...createReview(4),
    category: 'Customer Support',
    content: `Thanks to WasteWave for customer support with email. I solved the problem. And the code quality is good, too.`,
